          ...
          views: [
            {
              ...
              questions: [
                { id: 'cresta_sag_d', name: 'Cresta Sagital Externa', qty: 1, desc: 'Cresta prominente en la linea media dorsal del craneo', x: 50, y: 72, color: 'Rojo' },
                { id: 'parietal_d', name: 'Hueso Parietal', qty: 2, desc: 'Forma la boveda del craneo, detras del frontal', x: 55, y: 58, color: 'Azul' },
                { id: 'frontal_d', name: 'Hueso Frontal', qty: 2, desc: 'Grandes huesos planos que forman la frente', x: 50, y: 38, color: 'Verde' },
                { id: 'supraorb_d', name: 'Agujero Supraorbitario', qty: 2, desc: 'Canales supraorbitarios por donde pasan nervios y vasos', x: 38, y: 33, color: 'Amarillo' },
                { id: 'nasal_d', name: 'Hueso Nasal', qty: 2, desc: 'Forma el puente de la nariz', x: 35, y: 22, color: 'Naranja' },
                { id: 'proc_rostr_d', name: 'Procesos Rostrales del Nasal', qty: 2, desc: 'Extensiones anteriores del hueso nasal', x: 30, y: 13, color: 'Morado' },
                { id: 'incisivo_d', name: 'Hueso Incisivo', qty: 2, desc: 'Forma la escotadura nasoincisiva', x: 25, y: 8, color: 'Rojo' },
                { id: 'proc_palat_inc_d', name: 'Procesos Palatinos del Incisivo', qty: 2, desc: 'Contribuyen a formar el paladar oseo', x: 22, y: 12, color: 'Azul' },
              ]
            },
            {
              ...
              questions: [
                { id: 'diastema_v', name: 'Diastema', qty: 2, desc: 'Espacio sin dientes entre incisivos y premolares (donde va el bocado)', x: 30, y: 12, color: 'Rojo' },
                { id: 'canal_interinc_v', name: 'Canal Interincisivo', qty: 1, desc: 'Solo en caballos, conducto en el hueso incisivo', x: 25, y: 7, color: 'Azul' },
                { id: 'proc_alveolar_v', name: 'Procesos Alveolares', qty: 2, desc: 'Porciones del maxilar que contienen los alveolos dentarios', x: 35, y: 22, color: 'Verde' },
                { id: 'borde_interalv_v', name: 'Bordes Interalveolares', qty: 2, desc: 'Crestas oseas entre los alveolos de los dientes', x: 32, y: 18, color: 'Amarillo' },
                { id: 'proc_palat_max_v', name: 'Proceso Palatino del Maxilar', qty: 2, desc: 'Mayor parte del paladar oseo', x: 40, y: 30, color: 'Naranja' },
                { id: 'palatino_v', name: 'Hueso Palatino', qty: 2, desc: 'Formado por 2 laminas perpendiculares y 1 horizontal', x: 45, y: 42, color: 'Morado' },
                { id: 'lam_horiz_palat_v', name: 'Lamina Horizontal del Palatino', qty: 2, desc: 'Completa la parte posterior del paladar duro', x: 48, y: 45, color: 'Rojo' },
                { id: 'fisuras_palat_v', name: 'Fisuras Palatinas', qty: 2, desc: 'Aberturas en el paladar oseo', x: 30, y: 25, color: 'Azul' },
                { id: 'foram_palat_v', name: 'Foramenes Palatinos Mayores', qty: 2, desc: 'Paso de la arteria palatina mayor', x: 42, y: 38, color: 'Verde' },
                { id: 'vomer_v', name: 'Vomer (Tabique Nasal)', qty: 1, desc: 'Hueso impar que forma parte del tabique nasal', x: 50, y: 35, color: 'Amarillo' },
                { id: 'terigoides_v', name: 'Hueso Terigoides', qty: 2, desc: 'Pequeno hueso con gancho (hamulus) lateral al palatino', x: 55, y: 48, color: 'Naranja' },
                { id: 'ganchos_terig_v', name: 'Ganchos del Terigoides', qty: 2, desc: 'Procesos en forma de gancho del hueso terigoides', x: 58, y: 50, color: 'Morado' },
                { id: 'presfenoides_v', name: 'Porcion Presfenoides', qty: 1, desc: 'Parte anterior del esfenoides', x: 50, y: 53, color: 'Rojo' },
                { id: 'basiesfenoides_v', name: 'Porcion Basiesfenoides', qty: 1, desc: 'Parte posterior del esfenoides', x: 50, y: 60, color: 'Azul' },
                { id: 'sincondrosis_v', name: 'Sincondrosis Interesfenoidal', qty: 1, desc: 'Union cartilaginosa entre presfenoides y basiesfenoides', x: 50, y: 57, color: 'Verde' },
                { id: 'alas_esfen_v', name: 'Alas del Esfenoides', qty: 2, desc: 'Extensiones laterales del esfenoides', x: 60, y: 55, color: 'Amarillo' },
                { id: 'tuberc_musc_v', name: 'Tuberculo Muscular', qty: 2, desc: 'Protuberancia para insercion muscular en el esfenoides', x: 55, y: 63, color: 'Naranja' },
                { id: 'porcion_basilar_v', name: 'Porcion Basilar del Occipital', qty: 1, desc: 'Base del hueso occipital', x: 50, y: 72, color: 'Morado' },
                { id: 'porcion_basioccip_v', name: 'Porcion Basioccipital', qty: 1, desc: 'Superficie ventral del occipital frente al foramen magno', x: 50, y: 76, color: 'Rojo' },
                { id: 'foram_magno_v', name: 'Foramen Magno', qty: 1, desc: 'Gran abertura para la medula espinal', x: 50, y: 82, color: 'Azul' },
                { id: 'condilos_v', name: 'Condilos del Occipital', qty: 2, desc: 'Articulacion con el Atlas (C1)', x: 42, y: 85, color: 'Verde' },
                { id: 'aguj_estilomast_v', name: 'Agujero Estilomastoides', qty: 2, desc: 'Salida del nervio facial (VII)', x: 60, y: 70, color: 'Amarillo' },
              ]
            },
            {
              ...
              questions: [
                { id: 'parietal_l', name: 'Hueso Parietal', qty: 2, desc: 'Porcion superior-lateral del craneo', x: 65, y: 18, color: 'Rojo' },
                { id: 'temporal_l', name: 'Hueso Temporal', qty: 2, desc: 'Porcion lateral del craneo, contiene el oido', x: 72, y: 30, color: 'Azul' },
                { id: 'petrosa_l', name: 'Porcion Petrosa del Temporal', qty: 2, desc: 'Alberga el oido interno, hueso mas duro del craneo', x: 75, y: 35, color: 'Verde' },
                { id: 'timpanica_l', name: 'Porcion Timpanica del Temporal', qty: 2, desc: 'Rodea la cavidad del oido medio', x: 73, y: 40, color: 'Amarillo' },
                { id: 'escamosa_l', name: 'Porcion Escamosa del Temporal', qty: 2, desc: 'Parte plana y delgada del temporal', x: 70, y: 25, color: 'Naranja' },
                { id: 'proc_cig_temp_l', name: 'Proceso Cigomatico del Temporal', qty: 2, desc: 'Proyeccion que forma parte del arco cigomatico', x: 62, y: 38, color: 'Morado' },
                { id: 'arco_cig_l', name: 'Arco Cigomatico', qty: 2, desc: 'Puente oseo formado por temporal y cigomatico', x: 55, y: 35, color: 'Rojo' },
                { id: 'proc_cig_front_l', name: 'Proceso Cigomatico del Frontal', qty: 2, desc: 'Proyeccion del frontal que contribuye a la orbita', x: 45, y: 25, color: 'Azul' },
                { id: 'frontal_l', name: 'Hueso Frontal', qty: 2, desc: 'Forma la frente del caballo', x: 42, y: 15, color: 'Verde' },
                { id: 'maxilar_l', name: 'Hueso Maxilar (Cuerpo)', qty: 2, desc: 'Hueso grande que contiene los dientes superiores', x: 30, y: 45, color: 'Amarillo' },
                { id: 'cresta_fac_l', name: 'Cresta Facial', qty: 2, desc: 'Cresta del maxilar, no la tienen carnivoros', x: 35, y: 42, color: 'Naranja' },
                { id: 'infraorb_l', name: 'Agujero Infraorbitario', qty: 2, desc: 'Entra por el agujero etmoidal/maxilar y sale aqui', x: 25, y: 40, color: 'Morado' },
                { id: 'lacrimal_l', name: 'Hueso Lacrimal', qty: 2, desc: 'Borde anterior de la orbita, con orificio lacrimal', x: 40, y: 28, color: 'Rojo' },
                { id: 'canal_nasolac_l', name: 'Canal Nasolacrimal', qty: 2, desc: 'Origen del canal por donde drenan las lagrimas', x: 42, y: 32, color: 'Azul' },
                { id: 'nasal_l', name: 'Hueso Nasal', qty: 2, desc: 'Forma el puente de la nariz', x: 22, y: 25, color: 'Verde' },
                { id: 'incisivo_l', name: 'Hueso Incisivo (Premaxilar)', qty: 2, desc: 'Porcion anterior con incisivos superiores', x: 10, y: 48, color: 'Amarillo' },
                { id: 'mandibula_l', name: 'Mandibula', qty: 2, desc: 'Hueso movil inferior, contiene dientes inferiores', x: 35, y: 68, color: 'Naranja' },
                { id: 'etmoides_l', name: 'Etmoides', qty: 1, desc: 'Hueso que divide la parte nasal del craneo', x: 38, y: 22, color: 'Morado' },
              ]
            },
            {
              ...
              questions: [
                { id: 'escamosa_occ_c', name: 'Porcion Escamosa del Occipital', qty: 1, desc: 'Parte superior plana del hueso occipital', x: 50, y: 22, color: 'Rojo' },
                { id: 'protub_occ_c', name: 'Protuberancia Occipital Externa', qty: 1, desc: 'Prominencia en la linea media del occipital', x: 50, y: 15, color: 'Azul' },
                { id: 'cresta_nucal_c', name: 'Cresta Nucal', qty: 1, desc: 'Cresta para insercion de musculos y ligamento nucal', x: 50, y: 8, color: 'Verde' },
                { id: 'foram_magno_c', name: 'Foramen Magno', qty: 1, desc: 'Gran abertura por donde pasa la medula espinal', x: 50, y: 50, color: 'Amarillo' },
                { id: 'condilos_c', name: 'Condilos del Occipital', qty: 2, desc: 'Articulan con el Atlas (C1), solo en caballos tienen esta forma', x: 38, y: 60, color: 'Naranja' },
                { id: 'porcion_basilar_c', name: 'Porcion Basilar del Occipital', qty: 1, desc: 'Base del occipital visible desde atras', x: 50, y: 72, color: 'Morado' },
                { id: 'porcion_lat_c', name: 'Porcion Lateral del Occipital', qty: 2, desc: 'Partes laterales del occipital', x: 35, y: 45, color: 'Rojo' },
                { id: 'proc_paracond_c', name: 'Proceso Paracondilar', qty: 2, desc: 'Proyeccion inferior-lateral cerca del condilo', x: 30, y: 68, color: 'Azul' },
                { id: 'canal_hipogloso_c', name: 'Canal del Nervio Hipogloso', qty: 2, desc: 'Paso del nervio XII que inerva la lengua', x: 42, y: 65, color: 'Verde' },
              ]
            },
            {
              ...
              questions: [
                { id: 'incisivo_r', name: 'Hueso Incisivo', qty: 2, desc: 'Contiene los dientes incisivos superiores', x: 50, y: 65, color: 'Rojo' },
                { id: 'cara_labial_r', name: 'Cara Labial del Incisivo', qty: 2, desc: 'Superficie del incisivo que mira hacia los labios', x: 50, y: 55, color: 'Azul' },
                { id: 'apertura_r', name: 'Apertura Nasal Osea', qty: 1, desc: 'Abertura nasal formada por nasales e incisivos', x: 50, y: 30, color: 'Verde' },
                { id: 'infraorb_r', name: 'Agujero Infraorbitario', qty: 2, desc: 'Foramen de salida del nervio infraorbitario', x: 30, y: 45, color: 'Amarillo' },
                { id: 'escot_nasoinc_r', name: 'Escotadura Nasoincisiva', qty: 2, desc: 'Muesca entre hueso nasal e incisivo', x: 40, y: 38, color: 'Naranja' },
                { id: 'incisivos_d_r', name: 'Dientes Incisivos Superiores', qty: 6, desc: '6 incisivos superiores (3 por lado)', x: 50, y: 80, color: 'Morado' },
              ]
            }
          ],
          questions: [
            { id: 'frontal', name: 'Hueso Frontal', qty: 2, desc: 'Forma la frente y la boveda craneal', x: 40, y: 15, color: 'Rojo' },
            { id: 'parietal', name: 'Hueso Parietal', qty: 2, desc: 'Parte superior-posterior del craneo', x: 60, y: 20, color: 'Azul' },
            { id: 'temporal', name: 'Hueso Temporal', qty: 2, desc: 'Lateral del craneo, contiene el oido', x: 70, y: 40, color: 'Verde' },
            { id: 'occipital', name: 'Hueso Occipital', qty: 1, desc: 'Posterior del craneo, foramen magno', x: 80, y: 35, color: 'Amarillo' },
            { id: 'nasal', name: 'Hueso Nasal', qty: 2, desc: 'Forma el puente de la nariz', x: 15, y: 30, color: 'Naranja' },
            { id: 'maxilar', name: 'Maxilar', qty: 2, desc: 'Contiene dientes superiores, cresta facial', x: 25, y: 50, color: 'Morado' },
            { id: 'incisivo', name: 'Hueso Incisivo (Premaxilar)', qty: 2, desc: 'Contiene incisivos, forma la escotadura nasoincisiva', x: 10, y: 55, color: 'Rojo' },
            { id: 'mandibula', name: 'Mandibula', qty: 2, desc: 'Hueso movil inferior', x: 35, y: 70, color: 'Azul' },
            { id: 'lacrimal', name: 'Hueso Lacrimal', qty: 2, desc: 'Borde anterior orbita, canal nasolacrimal', x: 40, y: 28, color: 'Verde' },
            { id: 'etmoides', name: 'Etmoides', qty: 1, desc: 'Divide cavidad nasal del encefalo', x: 38, y: 22, color: 'Amarillo' },
            { id: 'esfenoides', name: 'Esfenoides', qty: 1, desc: 'Base del craneo, presfenoides y basiesfenoides', x: 50, y: 55, color: 'Naranja' },
            { id: 'palatino', name: 'Hueso Palatino', qty: 2, desc: '2 laminas perpendiculares + 1 horizontal', x: 40, y: 45, color: 'Morado' },
            { id: 'terigoides', name: 'Hueso Terigoides', qty: 2, desc: 'Hueso con ganchos lateral al palatino', x: 55, y: 48, color: 'Rojo' },
            { id: 'vomer', name: 'Vomer', qty: 1, desc: 'Tabique nasal oseo', x: 30, y: 35, color: 'Azul' },
            { id: 'cigomatico', name: 'Hueso Cigomatico', qty: 2, desc: 'Forma el pomulo y arco cigomatico', x: 50, y: 42, color: 'Verde' },
          ]
        },
        // ===== A. CABEZA Y CUELLO =====
        {
